...
static_assert(
    SubDeviceManager::MAX_NUM_SUB_DEVICES <= DispatchConstants::DISPATCH_MESSAGE_ENTRIES,
    "MAX_NUM_SUB_DEVICES must be less than or equal to DispatchConstants::DISPATCH_MESSAGE_ENTRIES");
...
void SubDeviceManager::populate_noc_data() {
    ...
    for (uint32_t i = 0; i < num_sub_devices; ++i) {
        ...
        TT_FATAL(
            idx <= DispatchConstants::DISPATCH_GO_SIGNAL_NOC_DATA_ENTRIES,
