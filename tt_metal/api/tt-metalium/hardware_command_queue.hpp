...
private:
    ...
    std::array<tt::tt_metal::WorkerConfigBufferMgr, DispatchConstants::DISPATCH_MESSAGE_ENTRIES> config_buffer_mgr;
    ...
    std::array<uint32_t, DispatchConstants::DISPATCH_MESSAGE_ENTRIES> expected_num_workers_completed_reset;
    std::array<tt::tt_metal::WorkerConfigBufferMgr, DispatchConstants::DISPATCH_MESSAGE_ENTRIES>
